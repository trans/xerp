...
module Xerp::Query::ResultId
  ...
  def self.generate(rel_path : String, block : Store::BlockRow, content_hash : Bytes) : String
  ...
  def self.generate(rel_path : String, line_start : Int32, line_end : Int32, content_hash : Bytes) : String
